    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose prose-gray max-w-none">
        <section className="mb-8">
          ...
          <p className="mb-4">
            By accessing and using EcomStore, you accept and agree to be bound by the terms and provision of this
            agreement.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Permission is granted to temporarily download one copy of the materials on EcomStore's website for personal,
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Shipping times are estimates and not guaranteed. Returns are accepted within 30 days of purchase in original
            condition.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            EcomStore shall not be liable for any damages arising from the use or inability to use our website or
            products.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">Questions about the Terms of Service should be sent to us at legal@ecomstore.com.</p>
        </section>
      </div>
    </div>
  )
